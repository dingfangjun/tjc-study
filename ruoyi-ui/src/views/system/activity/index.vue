<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="activityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="地点" align="center" prop="position" />
      <el-table-column label="人员" align="center" prop="users" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="时间" prop="time">
          <el-input v-model="form.time" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="地点" prop="position">
          <el-input v-model="form.position" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="人员" prop="users">
          <el-input v-model="form.users" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="联系方式" prop="telephone">
